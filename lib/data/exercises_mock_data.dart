...
class ExercisesMockData {
  ...
  List<Exercise> exercisesList = [
    ...
    Exercise(
      ...
      videoUrl: 'https://youtube.com/shorts/dCHdSxiAPU0',
      videoDuration: 21.3,
      steps: [
        StepModel(
          title: 'Posição Corporal',
    ...
    Exercise(
      ...
      videoUrl: 'https://youtube.com/shorts/GErYdn_fV3M',
      videoDuration: 13.3,
      steps: [
        StepModel(
          title: 'Posição Corporal',
    ...
    Exercise(
      ...
      videoUrl: 'https://youtube.com/shorts/KoMrT_pVrxk',
      videoDuration: 15.3,
      steps: [
        StepModel(
          title: 'Posição Corporal',
    ...
    Exercise(
      ...
      videoUrl: 'https://youtube.com/shorts/CL4akgrQtxk',
      videoDuration: 17.3,
      steps: [
        StepModel(
          title: 'Posição Corporal',
    ...
    Exercise(
      ...
      videoUrl: 'https://youtube.com/shorts/oglZAbwb4LI',
      videoDuration: 20.3,
      steps: [
        StepModel(
          title: 'Posição Corporal',
